    ...
    <div class="grid grid-cols-8 pt-3 sm:grid-cols-10">
      ...
      <div class="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
        ...
        <p class="mt-2">
          ...
          <a class="text-sm font-semibold text-blue-600 underline decoration-2" href="#"
            >Recover Account</a
          >
        </p>
        ...
        <div class="mb-10">
          ...
          <p class="mt-2">
            Make sure you have taken backup of your account in case you ever need to get access to
            your data. We will completely wipe your data. There is no way to access your account
            after this action.
          </p>
