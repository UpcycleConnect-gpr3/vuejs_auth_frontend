  ...
  <div class="mx-4 max-w-screen-xl sm:mx-8 xl:mx-auto">
    ...
    <div class="grid grid-cols-8 pt-3 pb-10 sm:grid-cols-10">
      ...
      <div class="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
        ...
        <div class="space-y-2">
          <div
            class="cursor-pointer rounded-md border bg-white px-6 py-2 text-2xl hover:bg-blue-50"
          >
            Marketing
          </div>
          <div class="cursor-pointer rounded-md border bg-blue-100 px-6 py-2 text-2xl">
            UI/UX Design
          </div>
          <div
            class="cursor-pointer rounded-md border bg-white px-6 py-2 text-2xl hover:bg-blue-50"
          ...
          <div class="rounded-md border bg-white">
            ...
            <div class="flex flex-col space-y-3 px-4 py-6 sm:px-10">
              <label class="block" for="name">
                ...
                <input
                  class="w-full rounded-md border py-2 px-2 bg-gray-50 outline-none ring-blue-600 focus:ring-1"
                  type="text"
                  value="Shakir Ali"
                />
              </label>
              ...
              <button class="mt-4 ml-auto rounded-lg bg-blue-600 px-10 py-2 text-white">
                Save
              </button>
            </div>
          </div>
